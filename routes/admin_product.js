    ...
    Product.findOne({ slug: slug }, (err, product) => {
      if (product) {
        ...
        product.save(err => {
          ...
          mkdirp(
            "public/product_image/" + product._id + "/gallery/thumbs",
            err => {
              return console.log(err);
            }
          );
...
router.post("/product-gallery/:id", (req, res) => {
  ...
  let thumbsPath =
    "public/product_image/" + id + "/gallery/thumbs/" + req.files.file.name;
...
router.get("/delete-image/:image", isAdmin, (req, res) => {
  let originalImage =
    "public/product_image/" + req.query.id + "/gallery/" + req.params.image;
  let thumbImage =
